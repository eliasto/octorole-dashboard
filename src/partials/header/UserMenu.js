...
function UserMenu() {
  ...
  return (
    <div className="relative inline-flex">
      ...
      >
        <img className="w-8 h-8 rounded-full" src={'https://cdn.discordapp.com/avatars/'+localStorage.getItem('discord_id')+'/'+localStorage.getItem('discord_avatar')+'.png'} width="32" height="32" alt="User" />
        <div className="flex items-center truncate">
          <span className="truncate ml-2 text-sm font-medium group-hover:text-gray-800">{localStorage.getItem('username').split('#')[0]}</span>
