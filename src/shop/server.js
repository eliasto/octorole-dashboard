      ...
      <div>
          ...
          <nav
                ...
                <div className="text-white pt-10">
                    <svg xmlns="http://www.w3.org/2000/svg" class="bg-purple-500 p-2 object-center rounded-full w-12 h-12 block m-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
      ...
      <div className="fixed inset-x-0 bottom-0">
        <div className="bg-purple-600">
          ...
          </main>:<div className="flex bg-gray-900 h-screen"><div className="m-auto"><svg class="animate-spin h-10 w-10 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg></div></div>}
      </div>
    );
